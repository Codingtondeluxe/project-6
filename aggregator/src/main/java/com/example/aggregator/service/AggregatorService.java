...
public class AggregatorService {
    ...
    // Extra Credit: Non-stream version of getAllPalindromes
    public List<Entry> getAllPalindromesNoStreams() {

        final List<Entry> candidates = new ArrayList<>();

        // Iterate from a to z using a traditional loop
        for (int i = 'a'; i <= 'z'; i++) {
        ...
        // test each entry for palindrome and collect palindromes
        ...
        palindromes.sort((e1, e2) -> e1.compareTo(e2));
